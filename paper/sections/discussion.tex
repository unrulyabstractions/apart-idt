...
Rescoring with a second judge model would test this directly.
...
Part of the study also never finished: we report one of the four calibration checkpoints, and nothing about the other three.
